...
import os
os.environ["HUGGINGFACEHUB_API_TOKEN"] = "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"
...
all_shakespeare_text[0].page_content[:300]
...
skspr_retriever = docsearch.as_retriever()
...
hf_llm_skspr = HuggingFacePipeline.from_model_id(
    model_id="google/flan-t5-large",
    task="text2text-generation",
    model_kwargs={
        "temperature": 0,
...
chain_type = "stuff"  # Options: stuff, map_reduce, refine, map_rerank
qa = RetrievalQA.from_chain_type(llm=hf_llm_skspr, 
                                 chain_type=chain_type, 
                                 retriever=skspr_retriever)
