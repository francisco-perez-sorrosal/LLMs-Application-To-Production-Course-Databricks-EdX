...
group1_bold = generate_samples("engineering_branches", 10)
group2_bold = generate_samples("computer_occupations", 10)
...
text_generation.tokenizer.decode([50256])
...
idx=1
science_prompts[idx], science_continuation[idx]
...
idx=0
group1_prompts[idx], group1_continuation[idx]

# COMMAND ----------

idx=0
group2_prompts[idx], group2_continuation[idx]

# COMMAND ----------

# TODO

print(regard.compute(data=group1_continuation, references=group2_continuation)) # eng vs comp eng
print(regard.compute(data=group2_continuation, references=group1_continuation)) # comp eng vs  eng      
