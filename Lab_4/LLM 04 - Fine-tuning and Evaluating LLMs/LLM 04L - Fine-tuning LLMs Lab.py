...
tokenizer.decode([50277], skip_special_tokens=False)

# COMMAND ----------

tokenizer.decode(tokenized_dataset['train'][0]['input_ids'], skip_special_tokens=False)
...
splitted_tokenized_ds = tokenized_dataset[split_dataset].train_test_split(train_size=TRAINING_SIZE, shuffle=False, seed=42)



# COMMAND ----------

splitted_tokenized_ds
...
trainer = Trainer(
  ...
  train_dataset=splitted_tokenized_ds[split_dataset],
  eval_dataset=splitted_tokenized_ds['test'],
)
